...
public class MessageService {
    ...
    public MessageService(MessageRepository messageRepository,
            ...
            MessageReceiptRepository messageReceiptRepository, MessageCryptoService messageCryptoService,
    ...
    public MessageEntity saveMessage(ChatMessageRequest req, String username) {
        ...
        try {
            ...
            initializeMessageReceipt(roomId, saveMessageEntity.getId());
    ...
    public void updateMessageReceiptDeliveredStatus(MessageDeliveryStatus status, String username) {
        ...
        UsersRoomsRolesEntity foundUsersRoomsRolesEntity = usersRoomsRolesRepository
                .findByIdUsernameAndIdRoomId(username, status.getRoomId()).orElse(null);

        if (messageEntity == null || foundUsersRoomsRolesEntity == null
                || !messageEntity.getRoomId().equals(status.getRoomId())) {
            return;
        }
